...
const IndexPage = () => (
  <Layout>
    <SEO title="I Love You Mom App Privacy Policy" />
    <h1>I Love You Mom &lt;3 Privacy Policy</h1>
    <h2>PRIVACY NOTICE</h2>
    <p>Last updated April 05, 2020</p>
    <p>
      Thank you for choosing to be part of our community at I Love You Mom &lt;3
      ...
      or concerns about our notice, or our practices with regards to your
      personal information, please contact us at __________. When you visit our
      mobile application, and use our services, you trust us with your personal
      ...
      "Services"). Please read this privacy notice carefully as it will help you
    ...
    <p>
      ...
      information regarding your mobile device, when you use our apps. If you
      use our Apps, we may also collect the following information: Mobile Device
      Access. We may request access or permission to certain features from your
      mobile device, including your mobile device's microphone, and other
      features. If you wish to change our access or permissions, you may do so
      in your device's settings.
    </p>

    <h4 id="infoshare">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h4>
    <p>
      ...
      business obligations. We may process or share data based on the following
      ...
      following situations: Vendors, Consultants and Other Third-Party Service
      ...
      third parties to use tracking technology on the Apps, which will enable
      them to collect data about how you interact with the Apps over time. This
      ...
      purposes. Business Transfers. We may share or transfer your information in
      connection with, or during negotiations of, any merger, sale of company
      assets, financing, or acquisition of all or a portion of our business to
      another company. Third-Party Advertisers. We may use third-party
      ...
      technologies in order to provide advertisements about goods and services
      of interest to you.
    </p>

    <h4 id="inforetain">3. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
    <p>
      ...
      keeping your personal information for longer than __________. When we have
    ...
    <h4 id="infominors">4. DO WE COLLECT INFORMATION FROM MINORS?</h4>
    <p>
      ...
      children under 18 years of age. By using the Apps, you represent that you
      ...
      data we have collected from children under age 18, please contact us at
      __________.
    </p>

    <h4 id="privacyrights">5. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
    <p>
    ...
    <h4 id="DNT">6. CONTROLS FOR DO-NOT-TRACK FEATURES</h4>
    <p>
    ...
    <p>
      ...
      Apps. To request removal of such data, please contact us using the contact
      ...
      sure the data is not publicly displayed on the Apps, but please be aware
      that the data may not be completely or comprehensively removed from our
      systems.
    </p>

    <h4 id="policyupdates">8. DO WE MAKE UPDATES TO THIS POLICY?</h4>
    <p>
    ...
    <h4 id="contact">9. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h4>
    <p>
      If you have questions or comments about this policy, you may email us at
      __________ or by post to: I Love You Mom &lt;3  __________ __________
    </p>
    ...
    <p>
      ...
      by clicking here. We will respond to your request within 30 days. This
